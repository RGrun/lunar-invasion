...
public class SpatialHashGrid {
	...
	public int[] getCellIds(GameObject obj) {
		int x1 = (int)FloatMath.floor(obj.bounds.bottomLeft.x / cellSize);
		int y1 = (int)FloatMath.floor(obj.bounds.bottomLeft.y / cellSize);
		int x2 = (int)FloatMath.floor((obj.bounds.bottomLeft.x + obj.bounds.width) / cellSize);
		int y2 = (int)FloatMath.floor((obj.bounds.bottomLeft.y + obj.bounds.height) / cellSize);
		...
		if(x1 == x2 && y1 == y2) {
			...
			if(x2 >= 0 && x2 < cellsPerRow && y1 >= 0 && y2 < cellsPerCol)

...
public class WeaponsScreen extends GLScreen {
    ...
    public WeaponsScreen(Game game) {
        ...
        orange = new Rectangle(8 * 32, 8 * 32, 6 * 32, 3 * 32);
        green = new Rectangle(8 * 32, 12 * 32, 6 * 32, 3 * 32);
        blue = new Rectangle(8 * 32, 16 * 32, 6 * 32, 3 * 32);
        purple = new Rectangle(8 * 32, 20 * 32, 6 * 32, 3 * 32);
        red = new Rectangle(8 * 32, 24 * 32, 6 * 32, 3 * 32);
    ...
    public void present(float deltaTime) {
        ...
        //menu items
        batcher.drawSprite(11 * 32, 1280 - (9.5f * 32), 6 * 32, 3 * 32, Assets.orange);
        batcher.drawSprite(11 * 32, 1280 - (13.5f * 32), 6 * 32, 3 * 32, Assets.green);
        batcher.drawSprite(11 * 32, 1280 - (17.5f * 32), 6 * 32, 3 * 32, Assets.blue);
        batcher.drawSprite(11 * 32, 1280 - (21.5f * 32), 6 * 32, 3 * 32, Assets.purple);

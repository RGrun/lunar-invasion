 ...
 *
 * Orange weapon tutorial
 */
public class OrangePage extends GLScreen {
    Vector2 touchPoint;
    Camera2D guiCam;
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.organgePage);
        batcher.drawSprite(360, 640, 720, 1280, Assets.orangePageRegion);
        batcher.endBatch();

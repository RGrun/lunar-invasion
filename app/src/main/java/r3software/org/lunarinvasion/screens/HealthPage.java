 ...
 *
 * health powerup tutorial
 */
public class HealthPage extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.healthPUPage);
        batcher.drawSprite(360, 640, 720, 1280, Assets.healthPUPageRegion);
        batcher.endBatch();

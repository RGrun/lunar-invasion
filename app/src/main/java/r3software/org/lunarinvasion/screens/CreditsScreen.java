 ...
 *
 * This screen displays the game's credits.
 */
public class CreditsScreen extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.drawSprite(360, 30 * 32, 13 * 32, 3 * 32, Assets.richard);
        batcher.drawSprite(360, 23 * 32, 13 * 32, 3 * 32, Assets.chris);
        batcher.drawSprite(360, 16 * 32, 13 * 32, 3 * 32, Assets.noel);

 ...
 */
public class GoalsPage extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.goalsPage);
        batcher.drawSprite(360, 640, 720, 1280, Assets.goalsPageRegion);
        batcher.endBatch();

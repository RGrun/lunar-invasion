 ...
 * Story screen #4
 */
public class StoryScreen4 extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.story4);
        batcher.drawSprite(360, 640, 720, 1280, Assets.story4Region);
        batcher.endBatch();

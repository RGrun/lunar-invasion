 ...
 * Green shot tutorial
 */
public class GreenPage extends GLScreen {
    Vector2 touchPoint;
    Camera2D guiCam;
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.greenPage);
        batcher.drawSprite(360, 640, 720, 1280, Assets.greenPageRegion);
        batcher.endBatch();

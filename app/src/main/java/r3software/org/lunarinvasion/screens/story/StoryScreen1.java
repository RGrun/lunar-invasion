...
import r3software.org.lunarinvasion.screens.HelpScreen;
 ...
 * Story screen #1
 */
public class StoryScreen1 extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.story1);
        batcher.drawSprite(360, 640, 720, 1280, Assets.story1Region);
        batcher.endBatch();

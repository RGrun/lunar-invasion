 ...
 * Story screen #3
 */
public class StoryScreen3 extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.story3);
        batcher.drawSprite(360, 640, 720, 1280, Assets.story3Region);
        batcher.endBatch();

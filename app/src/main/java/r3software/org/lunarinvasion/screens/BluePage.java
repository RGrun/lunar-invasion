 ...
 *
 * Blue Weapon tutorial
 */

public class BluePage extends GLScreen {
    Vector2 touchPoint;
    Camera2D guiCam;
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.bluePage);
        batcher.drawSprite(360, 640, 720, 1280, Assets.bluePageRegion);
        batcher.endBatch();

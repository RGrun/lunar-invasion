 ...
 * Movement tutorial
 */
public class MovementPage extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.movementPage);
        batcher.drawSprite(360, 640, 720, 1280, Assets.movementPageRegion);
        batcher.endBatch();

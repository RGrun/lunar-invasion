 ...
 * Story screen #5.
 */
public class StoryScreen5 extends GLScreen {
        ...
        for(int i = 0; i < len; i++) {
            ...
            if(event.type == Input.TouchEvent.TOUCH_UP) {
                ...
                if (OverlapTester.pointInRectangle(back, touchPoint)) {
                    ...
                    game.setScreen(new StoryScreen4(game));
                    return;
                }
                ...
                if(OverlapTester.pointInRectangle(nextScreen, touchPoint)) {
                    Assets.playSound(Assets.menuClick);
                    game.setScreen(new StoryScreen6(game));
                    return;
                }
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.story5);
        batcher.drawSprite(360, 640, 720, 1280, Assets.story5Region);
        batcher.endBatch();

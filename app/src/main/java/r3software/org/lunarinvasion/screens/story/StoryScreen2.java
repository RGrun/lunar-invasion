 ...
 * Story screen #2
 */
public class StoryScreen2 extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.story2);
        batcher.drawSprite(360, 640, 720, 1280, Assets.story2Region);
        batcher.endBatch();

 ...
 *
 * Purple weapon tutorial
 */
public class PurplePage extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(Assets.purplePage);
        batcher.drawSprite(360, 640, 720, 1280, Assets.purplePageRegion);
        batcher.endBatch();
